...
import june1.open.common.exception.auth.*;
import june1.open.common.exception.client.MemberExistException;
import june1.open.common.exception.client.NoSuchMemberException;
import june1.open.common.jwt.JwtUserInfo;
import june1.open.common.jwt.Token;
import june1.open.common.jwt.TokenProvider;
import june1.open.common.util.FileUtil;
import june1.open.controller.auth.dto.LoginResDto;
import june1.open.controller.auth.dto.MemberResDto;
import june1.open.controller.auth.dto.RegisterMemberReqDto;
...
import june1.open.repository.*;
import june1.open.service.dto.TokenDto;
...
public class AuthService {
    ...
    public LoginResDto reissue(String refresh) {
        ...
        if (!tokenProvider.isValidToken(refresh)) {
            log.error("[{}]사용자의 리프레쉬 토큰이 유효하지 않음", refresh);
            throw IllegalRefreshTokenException.builder()
                    .code(CODE_AUTH)
