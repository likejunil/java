package june1.vgen.open.common;
...
public class ConstantInfo {
    ...
    public static final String CORP_COLOR = "CORP_COLOR";
    public static final String CORP_ANIMAL = "CORP_ANIMAL";
    public static final String CORP_FRUIT = "CORP_FRUIT";
    ...
    public static final String BASE_PACKAGE = "june1.vgen.open";
